...
#
# lab2_matmul.tcl: Tcl script for re-creating project 'MatMul_v1_0_project'
#
# Generated by Vivado on Fri Apr 26 16:54:02 +0200 2019
...
#
# 1. This project restoration tcl script (lab2_matmul.tcl) that was generated.
#
...
#
#    "src/hdl/MatMul_v1_0_S00_AXI.v"
#    "src/hdl/mat_mul.v"
#    "src/hdl/MatMul_v1_0.v"
#    "src/component.xml"
#    "src/hdl/mat_mul_tb.v"
#
#*****************************************************************************************

variable partname xc7z020clg484-1
variable boardname "xilinx.com:zc702:part0:1.4"
...
set _xil_proj_name_ "Lab2_MatMul"
...
set script_file "lab2_matmul.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/lab2_matmul"]"

# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part $partname
...
set_property -name "board_part" -value "$boardname" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../lab2_tcl/lab2/ip_repo/MatMul_1.0"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/src/hdl/MatMul_v1_0_S00_AXI.v"] \
 [file normalize "${origin_dir}/src/hdl/mat_mul.v"] \
 [file normalize "${origin_dir}/src/hdl/MatMul_v1_0.v"] \
 [file normalize "${origin_dir}/src/component.xml"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/hdl/MatMul_v1_0_S00_AXI.v"
...
set file "$origin_dir/src/hdl/mat_mul.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/hdl/MatMul_v1_0.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/component.xml"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "top" -value "MatMul_v1_0" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "../lab2_tcl/lab2/ip_repo/MatMul_1.0/src/MatMul_v1_0.v" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/src/hdl/mat_mul_tb.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/src/hdl/mat_mul_tb.v"
set file [file normalize $file]
...
set_property -name "top" -value "mat_mul_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "../lab2_tcl/lab2/ip_repo/MatMul_1.0/src/mat_mul_tb.v" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part $partname -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part $partname -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
