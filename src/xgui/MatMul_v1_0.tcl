...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MATRIX_DIMENSION_LOG_2"
  ipgui::add_param $IPINST -name "MATRIX_DATA_WIDTH" -widget comboBox

}

proc update_PARAM_VALUE.MATRIX_DATA_WIDTH { PARAM_VALUE.MATRIX_DATA_WIDTH } {
	# Procedure called to update MATRIX_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MATRIX_DATA_WIDTH { PARAM_VALUE.MATRIX_DATA_WIDTH } {
	# Procedure called to validate MATRIX_DATA_WIDTH
	return true
}

proc update_PARAM_VALUE.MATRIX_DIMENSION_LOG_2 { PARAM_VALUE.MATRIX_DIMENSION_LOG_2 } {
	# Procedure called to update MATRIX_DIMENSION_LOG_2 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MATRIX_DIMENSION_LOG_2 { PARAM_VALUE.MATRIX_DIMENSION_LOG_2 } {
	# Procedure called to validate MATRIX_DIMENSION_LOG_2
	return true
}
...
proc update_MODELPARAM_VALUE.MATRIX_DIMENSION_LOG_2 { MODELPARAM_VALUE.MATRIX_DIMENSION_LOG_2 PARAM_VALUE.MATRIX_DIMENSION_LOG_2 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MATRIX_DIMENSION_LOG_2}] ${MODELPARAM_VALUE.MATRIX_DIMENSION_LOG_2}
}

proc update_MODELPARAM_VALUE.MATRIX_DATA_WIDTH { MODELPARAM_VALUE.MATRIX_DATA_WIDTH PARAM_VALUE.MATRIX_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MATRIX_DATA_WIDTH}] ${MODELPARAM_VALUE.MATRIX_DATA_WIDTH}
}
